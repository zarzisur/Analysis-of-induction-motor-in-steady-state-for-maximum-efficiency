...
%     xlabel('frequency');
%     ylabel('slip')
%     zlabel('power factor for linear method')
%     title('Contour of power factor for linear method ')
%     %%%shading interp % gets rid of black line in surface plot
%     colormap(jet(50)); % give a predefined colour choice
%     colorbar % Add a colorbar that acts as a legend for colors
%     
...
%     xlabel('frequency');
%     ylabel('slip');
%     zlabel('Input Phase current,RMS');
%     title('Input Phase current,RMS');
%      colormap(jet(50));
%     colorbar
%     
%     
%     
    ...
    ylabel('slip');
    zlabel('Input Power');
    title('Input Power for linear method');
    colormap(gray);
    colorbar
...
%     ylabel('slip');
%     zlabel('Efficiency');
%     title('Efficiency Using contour mapping')
%     colormap(jet(50));
%     colorbar
%     
    ...
    ylabel('slip');
    zlabel('Efficiency');
    title('Efficiency Using contour mapping for linear method')
    colormap(jet(50));
    colorbar
