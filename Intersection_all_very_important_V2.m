...
hold on
figure(8)
plot(f,mag_in_linear,'k.:','Linewidth',1);
hold on
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
figure(8)
plot(f,mag_in_quadretic,'k^:','Linewidth',1);
hold on
...
figure(8)
plot(f,mag_in_quadretic,'kp-','Linewidth',1);
hold on
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%% Linear with optimum voltage at low frequency region%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
vline2line=(f/50)*415;% generating 46 line to line voltage value correspondig to V/f relation
for n=1:21
    vline2line(n)=f(n)*4.9-18.91;
end
...
legend('linear','Quadretic','Optimized Quadratic','Optimized Linear');
...
figure(8)
plot(f,mag_in_quadretic,'kx-.','Linewidth',1);
xlabel('Frequency')
ylabel('Input Current at intersection point');
title('Input Current VS Frequency for Pump Load');
legend('linear','Quadretic','Optimized Quadratic','Optimized Linear');
