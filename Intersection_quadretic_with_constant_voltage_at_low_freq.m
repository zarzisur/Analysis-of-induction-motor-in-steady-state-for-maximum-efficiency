...
for i=1:6 % low frequency 5 to 10 Hz
    vline2line(i)=(10/50)^2*415;
end
...
xlabel('Spped')
ylabel('Torque')
title('Intersection point torque for constant voltage quadretic method')

figure
plot(Nr_cut,S_cut,'b*','Linewidth',1);
xlabel('Speed')
ylabel('Slip at intersection point');
title('Intersection point slip for constant voltage quadretic method')

figure
plot(f,vline2line,'b*','Linewidth',1);
xlabel('Frequency')
ylabel('Command line to line voltage');
title('Voltage Vs Frequency in constant voltage quadretic Method');

figure
plot(Nr_cut,pf_quadretic,'b*','Linewidth',1);
xlabel('Speed')
ylabel('Power factor at intersection point');
title('Intersection point power factor for constant voltage quadretic method')


figure
plot(Nr_cut,eff_quadretic,'b*','Linewidth',1);
xlabel('Speed')
ylabel('Efficiency at intersection point');
title('Intersection point efficiency for constant voltage quadretic method')
