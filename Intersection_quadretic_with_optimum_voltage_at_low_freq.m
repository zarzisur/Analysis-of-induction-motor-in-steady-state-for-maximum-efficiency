...
xlabel('Spped')
ylabel('Torque')
title('Intersection point torque for optimum quadretic method')

figure
plot(Nr_cut,S_cut,'b*','Linewidth',1);
xlabel('Speed')
ylabel('Slip at intersection point');
title('Intersection point slip for optimum quadretic method')

figure
plot(f,vline2line,'b*','Linewidth',1);
xlabel('Frequency')
ylabel('Command line to line voltage');
title('Voltage Vs Frequency in optimum quadretic Method');

figure
plot(Nr_cut,pf_quadretic,'b*','Linewidth',1);
xlabel('Speed')
ylabel('Power factor at intersection point');
title('Intersection point power factor for optimum quadretic method')
...
title('Intersection point efficiency for optimum quadretic method')
